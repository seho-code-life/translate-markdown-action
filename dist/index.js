...
var got = __nccwpck_require__(5020);

var languages = __nccwpck_require__(9665);
...
// EXTERNAL MODULE: ./node_modules/@vitalets/google-translate-api/index.js
var google_translate_api = __nccwpck_require__(1795);
var google_translate_api_default = /*#__PURE__*/__nccwpck_require__.n(google_translate_api);
;// CONCATENATED MODULE: ./src/utils.ts


const translateContent = async (content, flag) => {
    const regExp = new RegExp(`^${flag.start}\\n[\\s\\S]*${flag.end}\\n`);
    return await replaceAsync(content, regExp, async (match, name) => {
        try {
            return (await google_translate_api_default()(match, { to: 'en', tld: 'cn' })).text;
        }
        catch (error) {
            console.log(error);
            return match;
...
const readmeData = external_fs_default().readFileSync(beTranslatedFileName, 'utf-8');
